...
class DatabaseHelper{
  ...
  DatabaseHelper._createInstance(); // Named Cinstructor to create instance of DatabaseHelper

  // Define database along with the column name
  ...
  // Fetch Operation: Get all the note objects from the database
  ...
  // Inset Operation: Insert note object to the database
  ...
  Future<List<Note>> getNoteList() async{
    ...
    // List<Note> noteList; "Earlier this was declared which causes lots of errors" 
